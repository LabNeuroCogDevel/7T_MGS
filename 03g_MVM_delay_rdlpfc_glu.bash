...
rm 03g_MVM_delay_rdlpfc_glu_n115.nii.gz

3dMVM	-prefix 03g_MVM_delay_rdlpfc_glu_n115.nii -jobs 25	\
-bsVars "age*Glu.Cre+sex+FSfracGM"	\
-qVars "age,Glu.Cre,FSfracGM"	\
...
-dataTable	@rdlpfc_glu_delay_mvm_table.txt
